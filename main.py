...
#reading in the file
df = pd.read_csv('/Users/roxy/Documents/covid/conposcovidloc.csv')
...
df = df[(df['Reporting_PHU_City'] == 'Toronto')]
...
print("\nNumber of Positive Covid-19 Cases in Ontario")
print(df.shape[0] - 1)

deaths = df[df['Outcome1'] == 'Fatal']

print("\nNumber of Positive Covid-19 Deaths in Ontario")
